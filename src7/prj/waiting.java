...
public class waiting extends JPanel {
	...
	private ImageIcon roombasic_img = new ImageIcon("src/images/roomBasic.png");
	private ImageIcon roomentered_img = new ImageIcon("src/images/roomEntered.png");
	...
	private class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			if (event.getSource() == mkr_bt) {
				...
				F.cards.show(F.getContentPane(), "Three");
			}
		}
	}
	...
	public waiting(start f) {
		...
		//userexit_bt.setRolloverIcon(exitEntered2_img);  - setIcon동일 참고
		// 종료버튼의 테두리 설정을 해제시킴.
		...
		chatfield_tf.setBounds(20, 665, 975, 55);
		chatfield_tf.setCaretPosition(chatfield_tf.getText().length());
		chatfield_tf.setFont(font);
